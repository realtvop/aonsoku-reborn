...
export async function saveTokens(tokens: StoredDeviceTokens | null): Promise<void> {
	try {
		if (tokens) {
...
export async function saveConfig(config: CoordinationConfig | null): Promise<void> {
	try {
		if (config) {
